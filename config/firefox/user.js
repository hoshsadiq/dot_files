...
user_pref("browser.search.countryCode", "GB"); // (hidden pref)
user_pref("browser.search.region", "GB"); // (hidden pref)
...
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", 1519943881723);

// browser.urlbar.placeholderName;DuckDuckGo


// // customisation
// browser.uiCustomization.state;{"placements":{"widget-overflow-fixed-list":[],"PersonalToolbar":["personal-bookmarks"],"nav-bar":["back-button","forward-button","stop-reload-button","urlbar-container","downloads-button","library-button","sidebar-button","_testpilot-containers-browser-action","ublock0_raymondhill_net-browser-action","chrome-gnome-shell_gnome_org-browser-action","aws-extend-switch-roles_toshi_tilfin_com-browser-action","_2c4b535d-e705-4a71-a925-b53a8bca13d1_-browser-action","chrome-store-foxified_jetpack-browser-action","vim-vixen_i-beam_org-browser-action","https-everywhere_eff_org-browser-action","jid1-bofifl9vbdl2zq_jetpack-browser-action","jid1-mnnxcxisbpnsxq-eff_jetpack-browser-action"],"TabsToolbar":["tabbrowser-tabs","new-tab-button","alltabs-button","_c607c8df-14a7-4f28-894f-29e8722976af_-browser-action"],"toolbar-menubar":["menubar-items"]},"seen":["developer-button","_c607c8df-14a7-4f28-894f-29e8722976af_-browser-action","_testpilot-containers-browser-action","ublock0_raymondhill_net-browser-action","webide-button","chrome-gnome-shell_gnome_org-browser-action","aws-extend-switch-roles_toshi_tilfin_com-browser-action","_2c4b535d-e705-4a71-a925-b53a8bca13d1_-browser-action","https-everywhere_eff_org-browser-action","jid1-bofifl9vbdl2zq_jetpack-browser-action","jid1-mnnxcxisbpnsxq-eff_jetpack-browser-action"],"dirtyAreaCache":["PersonalToolbar","nav-bar","TabsToolbar","toolbar-menubar","widget-overflow-fixed-list"],"currentVersion":14,"newElementCount":9}
// browser.uidensity;1
...
// locale changes
user_pref("intl.locale.requested", "en-GB"); // (hidden pref)
...
user_pref("browser.taskbar.previews.enable", false); // windows only
